    ...
    Tables: {
      ...
      mieterhoehungen: {
        Row: {
          ...
          aktualisiert_am: string
          alte_betriebskosten: number
          alte_kaltmiete: number
          begruendung_text: string
          begruendungsart: string
          ...
          id: string
          mietvertrag_id: string
          neue_betriebskosten: number
          neue_kaltmiete: number
          status: string
          verlangt_am: string
          wirksam_ab: string
          zugestimmt_am: string | null
        }
        Insert: {
          abgelehnt_am?: string | null
          aktualisiert_am?: string
        ...
        Relationships: [
          {
            foreignKeyName: "mieterhoehungen_mietvertrag_id_fkey"
            columns: ["mietvertrag_id"]
            isOneToOne: false
            referencedRelation: "mietvertrag"
            referencedColumns: ["id"]
